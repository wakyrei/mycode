...
//        System.out.println();  
    ...
    public static void main(String[] args) throws Exception{
		...
		try {
			...
			FileInputStream dateIs = new FileInputStream(System.getProperty("user.dir")+File.separator+"date.txt");
			Properties p=new Properties();
			p.load(dateIs);
			String date_key = (String) p.get("date_key");
			String date_param = (String) p.get("date_param");
			//加载加密数据
			System.out.println("date_key:"+date_key);
			System.out.println("date_param:"+date_param);
			
			System.out.println("加密");
			//加密key
			String key = "123456789abcd";
			InputStream is= TestSign.class.getResourceAsStream("/rsa_public_key.pem"); 
			...
			//解密key
	        InputStream is2= TestSign.class.getResourceAsStream("/rsa_private_key.pem"); 
